...
import { OrganicShimmer } from "./organic-shimmer"
...
export function ThemeToggle() {
  ...
  },
  {
    ...
    description: "Wavy shimmer with phase-locked edge glow",
    pro: true,
    Component: OrganicShimmer,
    code: `"use client"
...
export function OrganicShimmer() {
  ...
  // never leaks past the rounded border. Highlight top, shade bottom give the
  // raised / embossed feel; the colored inset pulses on the same phase.
